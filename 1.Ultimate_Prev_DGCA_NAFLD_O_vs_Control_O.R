...
N_design_mat <- data.frame(Control_O = c(rep(0,nrow(NAFLD_O)),rep(1,nrow(Control_O))),
...
#            "Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Networks/New_DGCA/Prev_All_Non_Strict_DGCA_Control_O_vs_NAFLD_O.rds")
# 
...
# saveRDS(object = result_list, file = 
#            "Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Networks/New_DGCA/Strict_Prev_All_Non_Strict_DGCA_Control_O_vs_NAFLD_O.rds")
...
saveRDS(object = result_list, file = 
           "Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Networks/New_DGCA/ADJ_Prev_All_Strict_DGCA_Control_O_vs_NAFLD_O.rds")
...
saveRDS(object = result_list, file = 
           "Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Networks/New_DGCA/ADJ_Strict_Prev_All_Strict_DGCA_Control_O_vs_NAFLD_O.rds")
...
DGCA_All_Res_ADJ_Strict <- 
   Fisher_Procedure(N_megena_re_2_ADJ,
                    adjusted  = TRUE) %>% 
   as_tibble() %>% 
   dplyr::filter(Pvalue < 0.05) N_megena_res$summary$module.table
