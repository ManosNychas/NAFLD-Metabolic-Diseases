...
load("Users/manosnychas/Documents/Phd/HKI_PC/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/R_Datasets/Updated_NAFLD_O_L_KOs_CPM_Clinical_Data.RData")

df <-
  read.csv("Users/manosnychas/Documents/Phd/HKI_PC/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Metabolomics/metabolites_imputation.csv") %>% 
  as.data.frame() %>% 
...
distance_dataset <- Distance_Full$distances$Can_NMDS
