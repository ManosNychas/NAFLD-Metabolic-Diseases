...
PWA_BC_treat_NMDS <- pairwise.adonis2(BC_Comb ~  Groups, data = full, permutations = 999,by = "terms")
...
#write.csv(PWA_Results, "Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Figures_2/Supplemental_Figures/Tables/PWA_KEGG_ALL_NAFLD.csv")
...
pdf("Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Figures_2/Supplemental_Figures/PCOA_BC_KeggPaths_NAFLD_Controls.pdf", width = 10, height = 10)
pcoa_bc_beta_div
dev.off()
...
write.csv(RES
          ,"Documents/Metabolic_Diseases/Updated_Human3/NAFLD_O_L/Figures_2/Supplemental_Figures/Tables/PWA_KEGG_NAFLD.csv")
